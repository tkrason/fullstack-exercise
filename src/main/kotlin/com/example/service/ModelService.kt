...
import com.example.utils.extensions.toValidObjectIdOrThrow
...
abstract class ModelService<MODEL : Model>(
    ...
    suspend fun findModelByIdOrNull(id: String) = repository.findFirstById(id.toValidObjectIdOrThrow())
